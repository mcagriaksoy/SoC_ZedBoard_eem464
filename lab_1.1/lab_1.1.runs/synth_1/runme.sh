...
HD_PWD='C:/Users/mcagr/lab_1.1/lab_1.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mod_mul_with_oled.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mod_mul_with_oled.tcl
