...
HD_PWD='C:/Users/mcagr/lab_1.1/lab_1.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mod_mul_with_oled.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mod_mul_with_oled.tcl -notrace
